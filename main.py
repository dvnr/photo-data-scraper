...
#parser.add_argument('--id_start', default=20473, type=int, help='')
#parser.add_argument('--id_end', default=20475, type=int, help='')
parser.add_argument('--range_id', default=100, type=int)
...
with open("data.csv", "a") as csvfile:
    ...
    if len(data) == 0:
        ...
        id_start = int(data[-1].split(",")[0])
    id_end = id_start + range_id
